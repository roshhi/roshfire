    ...
    return(
        <div className='relative w-screen h-[500px] lg:h-[300px] mt-[80px] mb-[80px]  bg-cover bg-center bg-[url("./assets/images/featuredOffered.png")]'>
            <motion.div initial="hidden" whileInView="visible" variants={containerVariants} className="absolute inset-0 bg-black/50 grid grid-cols-2 gap-5 p-5 lg:grid-cols-4 md:p-10">
                ...
                <motion.div variants={itemsVariants2} className="group z-10 flex-center flex-col bg-white p-2 text-center rounded-sm gap-2 hover:border-4 hover:border-yellow-500 transform hover:translate-y-[-10px] transition-transform duration-300">
                ...
                <motion.div variants={itemsVariants3} className="group z-10 flex-center flex-col bg-white p-2 text-center rounded-sm gap-2 hover:border-4 hover:border-yellow-500 transform hover:translate-y-[-10px] transition-transform duration-300">
                ...
                <motion.div variants={itemsVariants4} className="group z-10 flex-center flex-col bg-white p-2 text-center rounded-sm gap-2 hover:border-4 hover:border-yellow-500 transform hover:translate-y-[-10px] transition-transform duration-300">
