...
export default function Order(){
    ...
    return (
        <motion.div initial="hidden" whileInView="visible" variants={containerVariants} className="bg-[rgb(249,249,249)] md:flex items-center justify-center w-[100vw] p-3 pt-[50px] pb-[50px] gap-3">
