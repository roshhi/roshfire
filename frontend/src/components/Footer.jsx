      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul>
              <li className="mb-2 text-gray-400 hover:text-[#DFB159] hover:font-bold cursor-pointer">
                Home
              </li>
              <li className="mb-2 text-gray-400 hover:text-[#DFB159] hover:font-bold  cursor-pointer">
                Shop
        ...
        <div className="border-t-2 border-[#DFB159] pt-6 pb-4 flex flex-col md:flex-row items-center justify-center gap-5 ">
          <p className="text-gray-500 text-sm">
            &copy; 2025 ROSHFIRE Weapon Store. All rights reserved.
          </p>

          <div className="flex mt-4 md:mt-0 space-x-4">
            <a
              href="https://github.com/roshhi/roshfire"
              target="_blank"
              className="hover:text-[#DFB159] transition text-[25px]"
            >
              <FaGithub />
            </a>
          </div>
