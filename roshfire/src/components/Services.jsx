...
export default function Services(){
    return(
        <div className='relative w-screen h-[500px] lg:h-[300px] bg-cover bg-center bg-[url("./assets/images/featuredOffered.png")]'>
            <div className="absolute inset-0 bg-black/50 grid grid-cols-2 gap-5 p-5 lg:grid-cols-4 md:p-10">
                <div className="group z-10 flex-center flex-col bg-white p-2 text-center rounded-sm gap-2 hover:border-4 hover:border-yellow-500 hover:translate-y-[-10px] transition-transform duration-300 ">
                    <FaAward className="text-[40px] text-purple-500"/>
                ...
                <div className="group z-10 flex-center flex-col bg-white p-2 text-center rounded-sm gap-2 hover:border-4 hover:border-yellow-500 hover:translate-y-[-10px] transition-transform duration-300">
                    <FaMoneyBillAlt className="text-[40px] text-orange-500"/>
                ...
                <div className="group z-10 flex-center flex-col bg-white p-2 text-center rounded-sm gap-2 hover:border-4 hover:border-yellow-500 hover:translate-y-[-10px] transition-transform duration-300">
                    <FaShoppingCart className="text-[40px] text-blue-500"/>
                ...
                <div className="group z-10 flex-center flex-col bg-white p-2 text-center rounded-sm gap-2 hover:border-4 hover:border-yellow-500 hover:translate-y-[-10px] transition-transform duration-300">
                    <FaTruck className="text-[40px] text-yellow-400"/>
